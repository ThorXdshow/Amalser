...
module.exports = {
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Noizy' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Imdadur' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/6b3766f8338b5cea212e0.jpg' : process.env.LG_LOGO,
